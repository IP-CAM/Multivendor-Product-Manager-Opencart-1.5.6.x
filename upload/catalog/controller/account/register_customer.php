<?php 
class ControllerAccountRegisterCustomer extends Controller {
	private $error = array();
  	...
  	public function index() {
    	...
    	$this->language->load('account/register_customer');
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
      	...
      	$this->data['breadcrumbs'][] = array(
        	'text'      => $this->language->get('text_register_customer'),
			'href'      => $this->url->link('account/register_customer', '', 'SSL'),      	
        	'separator' => $this->language->get('text_separator')
      	);
    	...
    	$this->data['action'] = $this->url->link('account/register_customer', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/register_customer.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/register_customer.tpl';
		} else {
			$this->template = 'default/template/account/register_customer.tpl';
		}
