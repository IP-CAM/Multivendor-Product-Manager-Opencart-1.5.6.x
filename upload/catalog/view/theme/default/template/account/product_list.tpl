...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="buttons">
  	<div class="left">
	  <a onclick="$('form').attr('action', '<?php echo $enable; ?>'); $('form').submit();" class="button" style="background:#8EC74B;"><?php echo $button_enable; ?></a>
	  <a onclick="$('form').attr('action', '<?php echo $disable; ?>'); $('form').submit();" class="button" style="background:#DC313E;"><?php echo $button_disable; ?></a>
  	</div>
  	<div class="right">
  ...
  <?php if ($error_max_products) { ?>
  <div class="alert warning"><?php echo $error_max_products; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close"></div>
  <?php } ?>
  ...
  <?php } ?>
  <?php if ($success) { ?>
  <div class="alert success"><?php echo $success; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close"></div>
  <?php } ?>
        ...
        <table class="list">
          ...
          <tbody>
            <tr class="filter">
              ...
              <td align="right"><input type="text" name="filter_quantity" value="<?php echo $filter_quantity; ?>" style="text-align: right;"  size="6" /></td>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($product['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="center"><a href="<?php echo $product['href']; ?>" target="_blank"><img src="<?php echo $product['image']; ?>" alt="<?php echo $product['name']; ?>" style="padding: 1px; border: 1px solid #DDDDDD;" /></a></td>
	      ...
	      <td class="left <?php echo (($product['status'] === $text_enabled) ? ('enabled') : ('disabled')); ?>"><?php echo $product['status']; ?></td>
              <td class="left <?php echo (($product['approved'] === $text_yes) ? ('approved') : ('not-approved')); ?>"><?php echo $product['approved']; ?></td>			    
