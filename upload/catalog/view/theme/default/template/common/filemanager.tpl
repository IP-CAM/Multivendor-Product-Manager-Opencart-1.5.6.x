...
<body>
<div id="container">
  <div id="menu"><a id="create" class="button" style="background-image: url('catalog/view/theme/default/image/filemanager/folder.png');"><?php echo $button_folder; ?></a><a id="delete" class="button" style="background-image: url('catalog/view/theme/default/image/filemanager/edit-delete.png');"><?php echo $button_delete; ?></a><a id="move" class="button" style="background-image: url('catalog/view/theme/default/image/filemanager/edit-cut.png');"><?php echo $button_move; ?></a><a id="copy" class="button" style="background-image: url('catalog/view/theme/default/image/filemanager/edit-copy.png');"><?php echo $button_copy; ?></a><a id="rename" class="button" style="background-image: url('catalog/view/theme/default/image/filemanager/edit-rename.png');"><?php echo $button_rename; ?></a><a id="upload" class="button" style="background-image: url('catalog/view/theme/default/image/filemanager/upload.png');"><?php echo $button_upload; ?></a><a id="refresh" class="button" style="background-image: url('catalog/view/theme/default/image/filemanager/refresh.png');"><?php echo $button_refresh; ?></a></div>
...
$(document).ready(function() { 
	...
	$('#column-right').bind('scrollstop', function() {
		$('#column-right a').each(function(index, element) {
			...
			if ((offset.top > 0) && (offset.top < height) && $(element).find('img').attr('src') == '<?php echo $no_image; ?>') {
				$.ajax({
					url: 'index.php?route=common/filemanager/image&image=' + encodeURIComponent('data/' + '<?php echo $cpm_image_subdir; ?>' + $(element).find('input[name=\'image\']').attr('value')),
					dataType: 'html',
	...
	$('#column-right a').live('dblclick', function() {
		...
		self.close();	
		<?php } else { ?>
		parent.$('#<?php echo $field; ?>').attr('value', 'data/' + '<?php echo $cpm_image_subdir; ?>' + $(this).find('input[name=\'image\']').attr('value'));
	...
	new AjaxUpload('#upload', {
		...
		onSubmit: function(file, extension) {
			$('#upload').append('<img src="catalog/view/theme/default/image/loading.gif" class="loading" style="padding-left: 5px;" />');
		},
